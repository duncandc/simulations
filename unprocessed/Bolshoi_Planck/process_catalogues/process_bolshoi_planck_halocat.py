...
def main():
    ...
    if len(sys.argv)>1:
        ...
        filename = 'hlist_1.00231.list'
    
    #set some properties
    simname = 'bolshoi_planck_250'
    version = 'custom'
    Lbox = 250.0
    particle_mass = 1.55*10**8.0
    halo_finder='Rockstar'
    
    #set the location and filename of the reduced catalogue
    savepath = '../../../processed_catalogues/Bolshoi_Planck/'
    ...
    columns_to_keep_dict = {'halo_id':              (1, 'i8'),
                            ...
                            'halo_vacc':            (61, 'f4'),
                            'halo_vpeak':           (62, 'f4'),
                            'halo_half_mass_scale': (63, 'f4'),
                            'halo_mpeak_scale':     (69, 'f4'),
                            'halo_acc_scale':       (70, 'f4'),
                            'halo_first_acc_scale': (71, 'f4'),
                            'halo_vmax_at_mpeak':   (74, 'f4'),
                            }
